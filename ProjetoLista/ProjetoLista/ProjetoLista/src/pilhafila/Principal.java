...
public class Principal {
		...
		/**
		 * Implemente um método para fazer a fusão de três pilhas ordenadas P1, P2 e P3 em uma
		quarta Pilha P4. Essa fusão deverá ser feita de tal forma que a pilha P4 permaneça
		ordenada
		 * **/
		
		void fusaoPilhas(Pilha p1, Pilha p2, Pilha p3, Pilha p4) {
			Pilha p1Aux = new Pilha();
			Pilha p2Aux = new Pilha();
			Pilha p3Aux = new Pilha();
			Pilha p4Aux = new Pilha();
			int x, y, z, q;
			x = p1.top();
			y = p2.top();
			z = p3.top();
		...
		//. Escreva um algoritmo que forneça o maior, o menor e a média aritmética dos elementos
		//de uma Pilha.
		void mediaPilha(Pilha p1) {
			Pilha aux = new Pilha();
			int maior = p1.top();
			int menor = p1.top();
			int soma = 0;
